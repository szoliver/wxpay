# wxpay V1.4(2021-5-9更新)
## 基于jquery3.6更新优化插件功能并修复部分问题
1.通过函数节流方式解决重复点击多次调用支付控件的问题；<br />
2.优化微信浏览器版本判断；<br />
3.支持回调返回金额为NaN时中止支付流程；<br />
解决众多问题，使用时业务逻辑部分代码请根据实际情况修改调试，核心代码无需修改

# wxpay V1.2.7(2016-3-15更新)
...
<script src="~/Content/js/wxPay-jquery.js"></script>
```
## [2].NuGet安装wxPay.Net组件并引用[废弃，未更新，请下载源码修改]

...
namespace wxPay.Net
{
    public class WxPayV3
    {
        ...
        public delegate void NotifySuccess(NotifyResult e);
        public delegate void NotifyFail(NotifyResult e);
        ...
        public static WXPayModel GetWXPayInfo(PayOrder payorder, string openid, int tfee, string body, string pid, string sp_billno, string cip = "0.0.0.0")
        {
            try
            {
                string timeStamp = "";
                ...
                Dos.Common.LogHelper.Debug("wxPayV3Info:" + System.Text.Json.JsonSerializer.Serialize(wxPayV3Info), "WXPAY");
                ...
                packageReqHandler.SetParameter("spbill_create_ip", cip);
                packageReqHandler.SetParameter("total_fee", tfee.ToString());
                ...
                var xmlDataInfo = new TenPayV3UnifiedorderRequestData(wxPayV3Info.AppId, wxPayV3Info.MchId, body, sp_billno, tfee,
                cip, wxPayV3Info.TenPayV3Notify, TenPayV3Type.JSAPI,
                 openid, wxPayV3Info.Key, nonceStr);

                //获取package包
                /* string sign = packageReqHandler.CreateMd5Sign("key", wxPayV3Info.Key);
                packageReqHandler.SetParameter("sign", sign);
                string data = packageReqHandler.ParseXML(); */
                Dos.Common.LogHelper.Debug("xmlDataInfo:" + System.Text.Json.JsonSerializer.Serialize(xmlDataInfo), "WXPAY");
                UnifiedorderResult result = TenPayV3.Unifiedorder(xmlDataInfo);
                if (result.prepay_id == null)
                {
                    string err_code = result.return_msg;
                ...
                package = string.Format("prepay_id={0}", result.prepay_id);
                //设置支付参数
        ...
        /// <returns></returns>
        public static string ProcessNotify(string wxKey,ResponseHandler resHandler, NotifySuccess success, NotifyFail fail)
        {
        ...
        public class WXPayModel
        {
            ...
            public string mchOrder { get; set; }

...
h.paySign?"function"===typeof l&&a(document).trigger("fail",h.package):(m=h.payFee/100,r=h.mchOrder,WeixinJSBridge.invoke("getBrandWCPayRequest",{appId:h.appId,timeStamp:h.timeStamp,nonceStr:h.nonceStr,"package":h.package,signType:"MD5",paySign:h.paySign},function(u){"get_brand_wcpay_request:ok"==u.err_msg?"function"===typeof g&&a(document).trigger("success",{fee:m,ordercode:r}):"get_brand_wcpay_request:fail"==u.err_msg?"function"===typeof l&&a(document).trigger("fail",u.err_desc):"function"===typeof n&&
a(document).trigger("cancel",h.payNo)}))},"json")}setTimeout(function(){p=!0},800)}else p=!0})}else a(this).click(function(){alert("\u8bf7\u5b89\u88c5\u5e76\u5347\u7ea7\u5fae\u4fe1APP\uff0c\u7248\u672c>=8.0.3\uff0c\u5f53\u524d\uff1a"+("0"==t?"\u975e\u5fae\u4fe1\u6d4f\u89c8\u5668":t))}),a(this).click()}};a.fn.SelectAddress=function(c,f,k,d,g,l,n){v(ver,"8.0.3")||a.fn.wxPay.Debug?a(this).click(function(){WeixinJSBridge.invoke("editAddress",{appId:c,scope:"jsapi_address",signType:"sha1",addrSign:f,timeStamp:k,
nonceStr:d},function(e){"edit_address:ok"==e.err_msg?a.isFunction(g)&&(a.fn.wxPay.SelectedAddr=e.proviceFirstStageName+" "+e.addressCitySecondStageName+" "+e.addressCountiesThirdStageName+" "+e.addressDetailInfo,g(e)):"edit_address:fail"==e.err_msg?a.isFunction(l)&&l(e.err_desc):a.isFunction(n)&&n("\u7528\u6237\u53d6\u6d88")})}):alert("\u8bf7\u5b89\u88c5\u5e76\u5347\u7ea7\u5fae\u4fe1APP\uff0c\u7248\u672c>=8.0.3\uff0c\u5f53\u524d\uff1a"+("0"==ver?"\u975e\u5fae\u4fe1\u6d4f\u89c8\u5668":ver))};a.fn.wxPay.SelectedAddr=
"";a.fn.wxPay.OrderParam="";a.fn.wxPay.OrderCode="";a.fn.wxPay.Debug=!1;a.fn.wxPay.WxVersion=function(){var c=navigator.userAgent.match(/MicroMessenger\/([\d\.]+)/i);return c?c[1]:"0"}})(jQuery,window);
